...
-- ----------------------------
-- Table structure for avbook_fanza_movie_genre_rel
-- ----------------------------
DROP TABLE IF EXISTS `avbook_fanza_movie_genre_rel`;
CREATE TABLE `avbook_fanza_movie_genre_rel`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `censored_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `genre_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_index_censored_id_genre_id`(`censored_id`, `genre_id`) USING BTREE,
